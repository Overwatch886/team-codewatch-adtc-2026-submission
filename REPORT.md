...
A different setup was actually built in the [https://github.com/Overwatch886/team-codewatch-adtc-2026-submission/tree/feature/dual-model-setup](feature/dual-model-setup) branch in this repo which uses a dual model architecture but this setup was not chosen because of better generation speeds and model swapping latency. That setup though is more memory efficient and functions smoothly under a 6 GB RAM systemd cgroups memory limit.
