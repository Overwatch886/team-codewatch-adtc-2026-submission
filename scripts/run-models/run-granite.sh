...
# Base Configurations
LLAMA_SERVER_BIN="$HOME/local_ai_workspace/software/llama.cpp/build/bin/llama-server" # Update if your binary path is elsewhere
MODEL_PATH="$HOME/local_ai_workspace/models/granite/granite-4.0-h-tiny-Q4_K_M.gguf" # Update to exact filename
PORT=8081
