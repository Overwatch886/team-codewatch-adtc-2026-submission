...
def spin_up_dynamic_model(model_key, threads=4, ctx=4096):
    ...
    # --mlock and -ngl 0 successfully wired into structural initialization string.
    cmd = (
...
def route_intent(user_input, has_image=False):
    ...
    if "QWEN" in intent:
        # High core assignment allocated strictly for Qwen-Reasoning parsing pass
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n[Router] Shutting down mesh layer gracefully.")#!/usr/bin/env python3
import os
import sys
import json
import subprocess
